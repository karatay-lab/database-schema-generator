...
export const PROJECT_NAME = "Diff Exhaustive Test";
...
export const api = {
  ...
  enums: {
    ...
    delete: (input: { projectName: string; version: string; name: string }) =>
      call<unknown>("enums.delete", "mutation", input),
    addValue: (input: { projectName: string; version: string; enumName: string; value: string }) =>
      call<unknown>("enums.addValue", "mutation", input),
    deleteValue: (input: { projectName: string; version: string; enumName: string; valueId: string }) =>
      call<unknown>("enums.deleteValue", "mutation", input),
  },
};
