...
const TABLES: { modelName: string; pkName: string; pkType: "Int" | "String" }[] = [
  { modelName: "User",     pkName: "id", pkType: "Int" },
  { modelName: "Category", pkName: "id", pkType: "Int" },
  { modelName: "Tag",      pkName: "id", pkType: "Int" },
  { modelName: "Post",     pkName: "id", pkType: "Int" },
  { modelName: "Comment",  pkName: "id", pkType: "Int" },
  { modelName: "Media",    pkName: "id", pkType: "Int" },
];
...
export async function createTables() {
  ...
  for (const table of TABLES) {
    ...
    console.log(`  ✓ Created table ${table.modelName} (pk: ${table.pkName} ${table.pkType})`);
  }
}
