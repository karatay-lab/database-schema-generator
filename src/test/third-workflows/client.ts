...
export const PROJECT_NAME = "MySQL Shop Schema";
export const VERSION = "1.0111";
export const PROVIDER = "MySQL" as const;
...
export const api = {
  ...
  tables: {
    ...
    update: (input: { projectName: string; version: string; oldModelName?: string; newModelName: string; pkName: string; pkType: PkType }) =>
  ...
  fields: {
    ...
    create: (input: FieldInput) => call<unknown>("fields.create", "mutation", input),
    update: (input: FieldInput & { oldFieldName?: string }) =>
